...
|RF-25| A página de gestão da loja deve permitir a visualização do histórico de pedidos |Baixo
...
|RNF-02     | O sistema deverá  se comunicar  com o banco de dados PostgreSQL | ALTA | 
